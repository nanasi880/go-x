...
func UnmarshalString(csv string, out interface{}) error {
	return Unmarshal(unsafeutil.StringToBytes(csv), out)
}
...
func (d *Decoder) decodeValue(raw string, rv reflect.Value) error {
	...
	rawBytes := unsafeutil.StringToBytes(raw)
	...
	case reflect.Int8, reflect.Int16, reflect.Int32, reflect.Int64, reflect.Int:
		v, err := strconv.ParseInt(raw, 10, reflectutil.IntegerBitSize(kind))
		if err != nil {
			return err
		}
		access.SetInt(v)
	...
	case reflect.Uint8, reflect.Uint16, reflect.Uint32, reflect.Uint64, reflect.Uint:
		v, err := strconv.ParseUint(raw, 10, reflectutil.IntegerBitSize(kind))
		if err != nil {
			return err
		}
		access.SetUint(v)
